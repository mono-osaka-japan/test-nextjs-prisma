...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const { name, description, status, startDate, endDate, budget, targetMetrics } = body;
    ...
    const campaign = await prisma.campaign.update({
      ...
      data: {
        ...
        ...(targetMetrics !== undefined && { metadata: targetMetrics ? JSON.stringify(targetMetrics) : null }),
      },
      include: {
        patterns: true,
      },
