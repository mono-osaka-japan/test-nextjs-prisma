...
CREATE TABLE "SystemGroup" (
    ...
    CONSTRAINT "SystemGroup_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PatternTestResult" (
    ...
    CONSTRAINT "PatternTestResult_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "CampaignTask_assigneeId_idx" ON "CampaignTask"("assigneeId");
...
-- AddForeignKey
ALTER TABLE "Pattern" ADD CONSTRAINT "Pattern_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pattern" ADD CONSTRAINT "Pattern_campaignId_fkey" FOREIGN KEY ("campaignId") REFERENCES "Campaign"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pattern" ADD CONSTRAINT "Pattern_systemGroupId_fkey" FOREIGN KEY ("systemGroupId") REFERENCES "SystemGroup"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PatternTestResult" ADD CONSTRAINT "PatternTestResult_patternId_fkey" FOREIGN KEY ("patternId") REFERENCES "Pattern"("id") ON DELETE CASCADE ON UPDATE CASCADE;
